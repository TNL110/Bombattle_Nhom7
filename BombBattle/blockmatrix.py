...
ASSETS = {  
    ...
    'exploding_box': [
      pygame.image.load('BombBattle-main/assets/exploding_box/exploding_box_{}.png'.format(i)) for i in range(1, 7)],
    'power_up_sound': pygame.mixer.Sound('BombBattle-main/assets/sound/power_up_sound.ogg')
}
