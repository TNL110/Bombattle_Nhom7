...
ASSETS = {  
    'bomb': [
      pygame.image.load('BombBattle-main/assets/bomb/bomb_{}.png'.format(i)) for i in range(1, 11)
    ],
    'bomb_chaining': pygame.image.load('BombBattle-main/assets/chaining_bomb.png'), 
    'bomb_explode_sound': pygame.mixer.Sound('BombBattle-main/assets/sound/explode.ogg')       
}
