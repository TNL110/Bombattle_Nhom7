...
MUSIC = pygame.mixer.music.load('BombBattle-main/assets/sound/game_music.ogg')
...
class BomBattle:
    def __init__(self):
        ...
        pygame.display.set_icon(pygame.image.load('BombBattle-main/assets/icon.png'))
    ...
    def new_classic_game(self):
        ...
        # self.mode = mode_game
        self.game = ClassicGame(self, self.screen, mode_game = self.mode)

    def new_classic_game_2_player(self):
        self.menu.is_open = False
        self.mode = 2
        self.game = ClassicGame(self, self.screen, mode_game = self.mode)
