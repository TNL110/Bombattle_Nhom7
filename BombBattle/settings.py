...
class Settings:    
    def __init__(self):               
        ...
        self.DEFAULT_PLAYER_2_CONTROLS = {
            'up': pygame.K_w,
            'down': pygame.K_s,
            'left': pygame.K_a,
            'right': pygame.K_d,
        ...
        self.GAME_FONT_MENU = pygame.font.Font('BombBattle-main/assets/font/PixelMiners-KKal.otf', 32) 
        self.GAME_FONT_GAME_BAR = pygame.font.Font('BombBattle-main/assets/font/PixelMiners-KKal.otf', 20) 

        self.screen_size = 650, 780
        self.running = True
        self.playtime = 200
        self.high_score = self.read_file('BombBattle-main/assets/point.txt')
