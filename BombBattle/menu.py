...
ASSETS = {
    'logo_game': pygame.image.load('BombBattle-main/assets/logo_game_2.png'),
    'menu_pointer': pygame.image.load('BombBattle-main/assets/menu_pointer.png'),     
}
...
class Menu:
    def __init__(self, screen, ai_game):
        ...
        self.options = {
          'main': [
            MenuOption(screen, '1 Player', self.ai_game.new_classic_game), 
            MenuOption(screen, '2 Player', self.ai_game.new_classic_game_2_player),
