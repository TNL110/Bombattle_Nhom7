...
ASSETS = {    
    'flame_center': [
      pygame.image.load('BombBattle-main/assets/explosion/explosion_center_{}.png'.format(i)) for i in range(1, 4)
    ],
    'flame_right': [
      pygame.image.load('BombBattle-main/assets/explosion/explosion_right_{}.png'.format(i)) for i in range(1, 4)
    ],
    'flame_left': [
      pygame.image.load('BombBattle-main/assets/explosion/explosion_left_{}.png'.format(i)) for i in range(1, 4)
    ],
    'flame_up': [
      pygame.image.load('BombBattle-main/assets/explosion/explosion_up_{}.png'.format(i)) for i in range(1, 4)
    ],
    'flame_down': [
      pygame.image.load('BombBattle-main/assets/explosion/explosion_down_{}.png'.format(i)) for i in range(1, 4)
    ],
    'flame_right_end': [
      pygame.image.load('BombBattle-main/assets/explosion/explosion_right_end_{}.png'.format(i)) for i in range(1, 4)
    ],
    'flame_left_end': [
      pygame.image.load('BombBattle-main/assets/explosion/explosion_left_end_{}.png'.format(i)) for i in range(1, 4)
    ],
    'flame_up_end': [
      pygame.image.load('BombBattle-main/assets/explosion/explosion_up_end_{}.png'.format(i)) for i in range(1, 4)
    ],
    'flame_down_end': [
      pygame.image.load('BombBattle-main/assets/explosion/explosion_down_end_{}.png'.format(i)) for i in range(1, 4)
    ],
