...
ASSETS = {
    'monster': {
      'up': [
        pygame.image.load('BombBattle-main/assets/monster/monster_up_{}.png'.format(i)) for i in range(1, 5)
      ],
      'down': [
        pygame.image.load('BombBattle-main/assets/monster/monster_down_{}.png'.format(i)) for i in range(1, 5)
      ],
      'left': [
        pygame.image.load('BombBattle-main/assets/monster/monster_left_{}.png'.format(i)) for i in range(1, 5)
      ],
      'right': [
        pygame.image.load('BombBattle-main/assets/monster/monster_right_{}.png'.format(i)) for i in range(1, 5)
      ],
      'idle': [
        pygame.image.load('BombBattle-main/assets/monster/monster_idle_{}.png'.format(i)) for i in range(1, 5)
      ],
    },
    'monster_dead': [
      pygame.image.load('BombBattle-main/assets/monster/monster_dead_{}.png'.format(i)) for i in range(1, 6)
    ],
    'monster_dead_sound': pygame.mixer.Sound('BombBattle-main/assets/sound/monster_dead_sound.ogg'),
    'door_opening_sound': pygame.mixer.Sound('BombBattle-main/assets/sound/door_opening_sound.ogg')         
...
class Monster:
    ...
    def die(self, lvl):
        ...
        if(self.game.high_score < self.game.score):
            ...
            Settings().write_file('BombBattle-main/assets/point.txt', self.game.score)
        self.time_to_disappear = 1   
        if len(lvl.monsters) == 1:            
            pygame.mixer.Sound('BombBattle-main/assets/sound/door_opening_sound.ogg').play() 
