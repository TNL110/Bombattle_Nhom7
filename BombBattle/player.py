...
ASSETS = {
    'player_up': pygame.image.load('BombBattle-main/assets/player/player_up.png'),
    'player_down': pygame.image.load('BombBattle-main/assets/player/player_right.png'),
    'player_left': pygame.image.load('BombBattle-main/assets/player/player_left.png'),
    'player_right': pygame.image.load('BombBattle-main/assets/player/player_right.png'),
    'player_die': [
      pygame.image.load('BombBattle-main/assets/player/player_die_{}.png'.format(i)) for i in range(1, 4)
    ],
    'player_die_sound': pygame.mixer.Sound('BombBattle-main/assets/sound/player_death_voice.ogg'),
    'bomb_placed_sound': pygame.mixer.Sound('BombBattle-main/assets/sound/place_bomb_sound.ogg')       
}
